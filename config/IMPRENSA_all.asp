...
'NOME DO ARQUIVO...: IMPRENSA_all.asp
...
//-->
    ...
    <div class="pathbar"><a href="#" onClick="return openScreen('dashboard1', 'general.asp');">Área de Trabalho</a> &gt; <%= iMod %></div>
...
If Trim(sValor) = "" Then
   SQL = "Select * From [" & iMod & "] Order By [a00id]"
Else
...
%>
                    ...
                    <% End If %>
                            ...
                            <tr>
                                ...
                                <td align="center" background="imagens/list-th-bg-sort.gif"><strong>TITULO</strong></td>
...
<%
   ...
   'If rsTemp("A04TIPO") = "1" Then: iOpt = "SIM": Else: iOpt = "NÃO"
   'If rsTemp("status") = "1" Then: iOpt = "<img src=""imagens/ok.gif"">": Else: iOpt = "<img src=""imagens/off.gif"">"
%>
                            <tr bgcolor="<%= pmCorSel %>">
                                <td align="center"><a href="#" onClick="return openScreen('dashboard1', '<%= iMod %>_edit.asp?id=<%= rsTemp(0) %>');"><img src="imagens/sis-search.gif" alt="Exibir/Editar este registro" border="0" align="absmiddle"></a></td>
                                <td align="Left"><%= UCase(rsTemp("a01titulo")) %></td>
                                <td align="Left"><%= UCase(rsTemp("a02link")) %></td>
                            </tr>
<%
   rsTemp.MoveNext
   Loop
