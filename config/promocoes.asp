...
sNot = 1
sCt  = request("ct")
sSel = "Select * From EMPRESA Where A00ID = 3"
...
//-->
	...
	<div class="screenTitle">
		...
		<tr>
			<td><img src="imagens/icons/ic_promocoes.gif">&nbsp;<% If sCt = "1" Then %><font color="#FF0000">Dados alterados com sucesso!</font><% Else %>&nbsp;<span class="name"><%= Session("nome") %></span> - Promoções/Editar<% End If %></td>
			<td class="uplevel">
	...
	<div class="screenBody" id="">
		...
		<form action="promocoes_options.asp?opt=2" method="post" enctype="multipart/form-data" name="cad1" id="cad1" onSubmit="return Validator(this);">
	<div class="formArea">

<div id="geral" style="top: 0px;">
<fieldset>
<legend>Promoções</legend><table width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td>
