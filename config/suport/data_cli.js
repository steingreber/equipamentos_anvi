...
var bmenuItems = [
    ...
    ["Informações Gerais","javascript:show(true,'geral');javascript:show(false,'historico');", "", "", "", "", "", "", "", "", "",],
    ["Histórico clínico","javascript:show(true,'historico');javascript:show(false,'geral');", "", "", "", "", "", "", "", "", "",],
];
