...
'NOME DO ARQUIVO...: IMPRENSA_edit.asp
...
//-->
    ...
    <div class="screenBody" id="">
        ...
        <form action="<%= LCase(iMod) %>_options.asp?opt=2&id=<%= sNot %>" method="post" name="cad1" id="cad1" onSubmit="return ValidaIMPRENSA(this);">
...
<tr>
    ...
    <td><input type="text" name="cp_a01titulo" value="<% = va_a01titulo %>" size="100" maxlength="255"></td>
</tr>
<tr>
    <td class="name">Link&nbsp;<span class="required">*</span></td>
    <td><input type="text" name="cp_a02link" value="<% = va_a02link %>" size="100" maxlength="255"></td>
</tr>
<tr>
    <td colspan="2">
<%
...
End Function
content = freeRTE_Preload(va_a03texto)
%>
