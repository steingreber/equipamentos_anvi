...
//-->
    ...
    <div class="pathbar"><a href="#" onClick="return openScreen('dashboard1', 'general.asp');">Área de Trabalho</a> &gt; <a href="#" onClick="return openScreen('dashboard1', 'produtos_all.asp');">Produtos</a> &gt; <a href="#" onClick="return openScreen('dashboard1', 'produtoslinhas_all.asp');">Linhas</a> &gt; Novo Registro</div>

    <div class="screenTitle">
        <table width="100%" cellspacing="0">
        <tr>
            <td><img src="imagens/icons/ic_produtos.gif"><span class="name"><%= Session("nome") %></span> - Linhas - Novo</td>
            <td class="uplevel">
                <div class="commonButton"><span id="spanid-shortcut-add"><a href="#" onClick="return openScreen('dashboard1', 'produtoslinhas_all.asp');"><img src="imagens/btn_uplevel_bg.gif" alt="" border="0" align="absmiddle">&nbsp;Voltar</a></div>
            </td>
        </tr>
        </table>
    </div>
    ...
    <div class="screenBody" id="">
        ...
        <form action="<%= LCase(iMod) %>_options.asp?opt=1" method="post" name="cad1" id="cad1" onSubmit="return ValidaPRODUTOSLinhas(this);">
...
<tr>
    ...
    <td><input type="text" name="cp_descri" size="60" maxlength="200"></td>
</tr>
<tr>
