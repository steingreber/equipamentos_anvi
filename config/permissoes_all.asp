...
//-->
	...
	<div class="pathbar"><a href="#" onClick="return openScreen('dashboard1', 'general.asp');">Área de Trabalho</a> &gt; Permissões</div>
	
	<div class="screenTitle">
		<table width="100%" cellspacing="0">
		<tr>

			<td><img src="imagens/icons/ic_<%= iMod %>.gif">&nbsp;<span class="name"><%= Session("nome") %></span> - Permissões</td>
			<td class="uplevel">
				<div class="commonButton"><span id="spanid-shortcut-add"><a href="#" onClick="return openScreen('dashboard1', 'general.asp');"><img src="imagens/btn_uplevel_bg.gif" alt="" border="0" align="absmiddle">&nbsp;Voltar</a><font color="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;</font></div>			</td>
		</tr>
		</table>
	</div>
...
<legend>Lista de usuários</legend><table width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td>
<div class="listArea">
	<a href="#" onClick="return openScreen('dashboard', '<%= iMod %>_new.asp');"><img src="imagens/on.gif" alt="" border="0" align="absmiddle">&nbsp;Cadastrar novo usuário</a>	
<div>
</td></tr></table>
...
%>
					...
					<% End If %>
                            ...
                            <tr>
                                ...
                                <td align="center" background="imagens/list-th-bg-sort.gif"><strong>NOME</strong></td>
                                <td align="center" background="imagens/list-th-bg-sort.gif"><strong>EMAIL</strong></td>
...
<%
   ...
   If rsTemp("a04ativo") = "1" Then: iPerm = "SIM": Else: iPerm = "NÃO"
%>
                            <tr bgcolor="<%= pmCorSel %>">
                                <td align="center"><a href="#" onClick="return openScreen('dashboard1', '<%= iMod %>_edit.asp?id=<%= rsTemp(0) %>');"><img src="imagens/sis-search.gif" alt="Exibir este..." border="0" align="absmiddle"></a></td>
                                <td align="left"><%= rsTemp("a01nome") %></td>
                                <td align="Left"><%= rsTemp("a02email") %></td>
                                <td align="Center"><%= iPerm %></td>
                            </tr>
<%
   rsTemp.MoveNext
   Loop
