...
sNot = 1
sCt  = request("ct")
sSel = "Select * From EMPRESA Where A00ID = 1"
...
//-->
	...
	<div class="pathbar"><a href="#" onClick="return openScreen('dashboard1', 'general.asp');">Área de Trabalho</a> <!--  &gt; <a href="#" onClick="return openScreen('dashboard1', '<%= LCase(iMod) %>.asp');"><%= iMod %>urações</a>  -->&gt; Editar/Ver <%= iMod %></div>
	...
	<div class="screenBody" id="">
		...
		<form action="<%= iMod %>_options.asp?opt=2" method="post" enctype="multipart/form-data" name="cad1" id="cad1" onSubmit="return Validator(this);">
	<div class="formArea">
