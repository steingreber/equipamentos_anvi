...
'NOME DO ARQUIVO...: PRODUTOS_edit.asp
...
'-----------------------------------------------
va_a06ativo                = Trim(objRS("a06ativo"))
va_a01produto              = Trim(objRS("a01produto"))
va_a08descricao            = Trim(objRS("a08descricao"))
va_a02linha                = Trim(objRS("a02linha"))
va_a05foto                 = Trim(objRS("a05foto"))
va_a10resumo               = Trim(objRS("a10resumo"))
'-----------------------------------------------
%>
<html>
...
//-->
    ...
    <div class="pathbar"><a href="#" onClick="return openScreen('dashboard1', 'general.asp');">Área de Trabalho</a> &gt; <a href="#" onClick="return openScreen('dashboard1', '<%= LCase(iMod) %>_all.asp');"><%= iMod %></a> &gt; Exibir/Editar</div>
    ...
    <div class="screenBody" id="">
        ...
        <form action="<%= LCase(iMod) %>_options.asp?opt=2&id=<%= sNot %>" method="post" enctype="multipart/form-data" name="cad1" id="cad1" onSubmit="return ValidaPRODUTOS(this);">
...
<tr>
    ...
    <td>
         <input type="radio" name="cp_a06ativo" value="1"<% If va_a06ativo = "1" Then %> checked style="background-color: #C0C0C0;"<% End If %>>SIM&nbsp;
         <input type="radio" name="cp_a06ativo" value="0"<% If va_a06ativo = "0" Then %> checked style="background-color: #C0C0C0;"<% End If %>>NÃO&nbsp;
    </td>
    </td>
</tr>
<tr>
    <td class="name">Produto&nbsp;<span class="required">*</span></td>
    <td><input type="text" name="cp_a01produto" value="<% = va_a01produto %>" size="60" maxlength="200"></td>
</tr>
<tr>
	<td colspan="2">
<%
...
<tr>
    ...
    <td><input type="text" name="cp_a10resumo" value="<% = va_a10resumo %>" size="60" maxlength="254"></td>
</tr>
<tr>
...
<%Do While not objRs.EOF%>
                <option value="<%= objRs("idSub") %>"<% If va_a02linha = Trim(objRS("idSub")) Then %> selected<% End If %>><%= objRs("descri") %></option>
<% objRs.MoveNext
Loop
objRs.close %>
                </select>
...
<tr>
    ...
    <td><input type="file" name="cp_a05foto" size="50"></td>
</tr>
<tr>
    <td class="name">Selecione a orientação da imagem</td>
    <td>
    ...
    &nbsp;&nbsp;Amostra da Imagem:&nbsp;<img src="imgProdutos/<%= va_a05foto %>" alt="" width="50" height="50" border="0" align="absmiddle">
    </td>
</tr>
</table>
</td></tr></table>
