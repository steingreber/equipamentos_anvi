...
//-->
	...
	<div class="pathbar"><a href="#" onClick="return openScreen('dashboard1', 'general.asp');">Área de Trabalho</a> &gt; <a href="#" onClick="return openScreen('dashboard1', '<%= iMod %>_all.asp');"><%= iMod %></a> &gt; Novo Registro</div>
	
	<div class="screenTitle">
		<table width="100%" cellspacing="0">
		<tr>
			<td><img src="imagens/ok.gif" width="16" height="16" alt="ok.gif" title="">&nbsp;<span class="name"><%= Session("nome") %></span> - <%= iMod %>/Novo</td>
			<td class="uplevel">
				<!-- <div class="commonButton"><span id="spanid-shortcut-add"><a href="#" onclick="return confirm_delete()"><img src="imagens/btn_remove-selected_bg.gif" alt="" border="0" align="absmiddle">&nbsp;Excluir este cliente</span></a></div> -->
			</td>
		</tr>
		</table>
	</div>
	...
	<div class="screenBody" id="">
		...
		<form action="<%= iMod %>_options.asp?opt=1" method="post" enctype="multipart/form-data" name="cad1" id="cad1" onSubmit="return Validator(this);">

	<div class="formArea">

<div id="geral" style="top: 0px;">
<fieldset>
<legend>Dados gerais</legend><table width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td>
<table class="formFields" cellspacing="0" width="100%">
<tr>
	<td class="name">Menu&nbsp;<span class="required">*</span></td>
	<td><input type="text" name="cp_A01MENU" size="50" maxlength="60"></td>
</tr>
<tr>
	<td class="name">Link&nbsp;<span class="required">*</span></td>
	<td><input type="text" name="cp_A02LINK" size="50" maxlength="60"></td>
</tr>
<tr>
	<td class="name">Ativo&nbsp;<span class="required">*</span></td>
	<td>
         <input type="radio" name="cp_A03ATIVO" value="1"><span class="fontTD">SIM</span>&nbsp;
         <input type="radio" name="cp_A03ATIVO" value="0"><span class="fontTD">NÃO</span>
	</td>
</tr>
<tr>
	<td class="name">Permissoes&nbsp;<span class="required">*</span></td>
	<td>
         <input type="radio" name="cp_A05PERMISSOES" value="1"><span class="fontTD">SIM</span>&nbsp;
         <input type="radio" name="cp_A05PERMISSOES" value="0"><span class="fontTD">NÃO</span>
	</td>
</tr>
<tr>
	<td class="name">Icone&nbsp;<span class="required">*</span></td>
	<td><input type="file" name="cp_A04ICONE" size="50"></td>
</tr>
</table>
</td></tr></table>
</fieldset>
